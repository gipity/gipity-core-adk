...
export const Login: React.FC = () => {
  ...
  if (showForgotPassword) {
    return (
      <div
        className="min-h-screen bg-gray-50 dark:bg-gray-900 px-4 py-8 overflow-y-auto"
        style={{ paddingTop: "calc(2rem + var(--safe-area-inset-top, 0px))" }}
      >
          ...
          <CardContent>
            ...
            <div className="text-center mt-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <Link
                  href="/signup"
                  className="text-[#476A92] dark:text-[#476A92] hover:underline"
                >
                  Create one
                </Link>
              </p>
